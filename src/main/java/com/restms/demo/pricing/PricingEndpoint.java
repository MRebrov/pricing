package com.restms.demo.pricing;
...
public class PricingEndpoint implements InitializingBean {
    ...
    public List<String> getPricedPortfolio(@PathVariable("customer-id") Integer customerId,
        ...
        // query for the portfolios, returned as an array of List of size 2, containing a ticker and a position (# of shares)
        Object[] portfolio = restTemplate.getForObject(url, Object[].class);
        // Look up the shares prices, and return a list of Strings, formatted as ticker, shares, price, total
